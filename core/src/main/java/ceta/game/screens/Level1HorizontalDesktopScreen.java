 ...
 */
public class Level1HorizontalDesktopScreen extends AbstractGameScreen{
    private static final String TAG = Level1HorizontalDesktopScreen.class.getName();
...
//    }
    ...
    public Level1HorizontalDesktopScreen(DirectedGame game, int levelNr, TextureAtlas.AtlasRegion regtex) {
