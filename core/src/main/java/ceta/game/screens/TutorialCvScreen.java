 ...
 */
public class TutorialCvScreen extends AbstractGameScreen {
    private static final String TAG = TutorialCvScreen.class.getName();
    ...
    public TutorialCvScreen(DirectedGame game) {
        super(game);
        goingVisible = true;
        changeStay = 1.5f;
