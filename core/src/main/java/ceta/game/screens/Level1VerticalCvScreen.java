...
public class Level1VerticalCvScreen extends Level1VerticalScreen {
    ...
    public Level1VerticalCvScreen(DirectedGame game, int levelNr) {
        super(game,levelNr);
    }
    ...
    public void show() {
        ...
        worldRenderer = new WorldRenderer1VerticalCV(worldController,stage, false); //false because is vertical!!
        // android back key
