 ...
 */
public class CVBlocksDesktopManager extends AbstractBlocksManager {
    public static final String TAG = CVBlocksDesktopManager.class.getName();
    ...
    public CVBlocksDesktopManager(DirectedGame game, Stage stage){
    ...
    public void init() {
        ...
        if((Gdx.app.getType() == Application.ApplicationType.Desktop)) {
        	//TODO:Smarichal 70 is the max diameter of the markers. This value was calibrated considering the tablet version. However, 
        	//this could change in the desktop environment and needs to be re-calibrated
            topCodeDetector = new TopCodeDetectorDesktop(50, true, 70, 5, true, false, true, detectionZone,true); 
        }else{
        	throw new RuntimeException("Wrong type of Manager. CVBlocksDetectionManager can only be used in desktop environments");
        }
